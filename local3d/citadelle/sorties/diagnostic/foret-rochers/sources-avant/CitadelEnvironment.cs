...
namespace ForgeLocal3D
{
    ...
    public sealed class CitadelEnvironment : MonoBehaviour
    {
        ...
        public void Apply()
        {
            ...
            sun.transform.rotation=Quaternion.Euler(33,-42,0);sun.color=new Color(.84f,.89f,1);sun.intensity=Mathf.Lerp(weather==0?1.8f:1.35f,.18f,night);
            ...
            RenderSettings.fogStartDistance=weather==2?110:240;RenderSettings.fogEndDistance=weather==2?560:1050;
